import { EAktionDTO, EAnlageDTO, EAuftragPhaseDTO, ELeistungDTO, EProjektDTO } from "../api"
import { FormBeilageDef, FormularStatus } from "../services"
...
export const ProjektPhaseFn = {
    ...
    //     return ''
    // },
    EmptyStatus(status: FormularStatus): boolean {
        return status === FormularStatus.Leer
    },
