...
import { EAktionDTO, EAnlageDTO, EAuftragPhaseDTO, EFormularDTO, ELeistungDTO, EProjektDTO } from "../api"
import * as schemas from 'src/app/schemas';
import { TranslocoService } from "@ngneat/transloco";
import { marker } from "@ngneat/transloco-keys-manager/marker";
import { ISchema } from "../components";
import { FormularStatus, getFormularTypBeilagenDefs } from "../services";
...
const addProjektPhaseDatei = (
	...
	if (aktion.dokument)
	{
		datei.status = FormularStatus.InBearbeitung
    	}
	else
	{
		datei.status = FormularStatus.Leer
	}
